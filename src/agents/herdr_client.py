    ...
    def _start_existing(self, run: RunSnapshot, spec: RunSpec) -> RunSnapshot:
        ...
        if spec.mock:
            ...
            if (
                ...
                or not isinstance(agent.get("workspace_id"), str)
