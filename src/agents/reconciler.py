...
def _reserve_terminal_unchecked(
    ...
    *,
    ...
    cursor = connection.execute(
        "INSERT INTO terminal_runs(session_name,profile_name,mcp_name,profile_sha256,provider,model,generation,actor_slug,purpose_kind,purpose_id,working_directory,token_digest,profile_state,state,output_tail,launch_count,created_at,updated_at)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,'reserved','',0,?,?)",
        (
            "reserved",
            "reserved",
            "reserved",
